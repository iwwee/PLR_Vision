...
void NYAutoRecognize::drawLicense(Mat &img, NYPlate plate, int index) {
    ...
    // 保存
    imwrite("/Users/NathanYu/Desktop/PLR_Vision/PLR_Vision/resources/drawcar.jpg", img);
    
    // 保存车牌
    Mat plr = plate.getPlateMat();
    char plrPath[150];
    sprintf(plrPath, "/Users/NathanYu/Desktop/PLR_Vision/PLR_Vision/resources/plate%d.jpg",index);
    imwrite(plrPath, plr);
    
    // 保存字符
    char charPath[150];
    sprintf(charPath, "/Users/NathanYu/Desktop/PLR_Vision/PLR_Vision/resources/%dchar_", index);
